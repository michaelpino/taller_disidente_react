export default function Item({ id, title, price, pictureUrl }) {
    return (
        <div key={id} className="justify-items-center max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href={pictureUrl}>
                <img className="p-8 rounded-t-lg max-h-60" src={pictureUrl} alt={title} />
            </a>
